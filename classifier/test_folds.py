...
def evaluate_fold(folder_path, X, Y, confusion_path= "confusion_fold.png", method = "random_forest", max_depth = 8, no_trees = 500, lr = 5):
...
def main():
    ...
    for i in range(len(folders_list)):
        metrtic_dict = evaluate_fold(folders_list[i], X, Y, os.path.join(confusion_root, "fold_" + str(i) + ".png"))
